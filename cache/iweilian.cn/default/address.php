...
<head>
 ...
 <meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
	...
	<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/script/common.js"></script>
	<link type="text/css" rel="stylesheet" href="http://iweilian.cn/baijia/themes/default/__RESOURCE__/mobile/style/bootstrap.css">
	<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/script/bootstrap.js"></script>
	<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/script/angular.min.js"></script>
	<link type="text/css" rel="stylesheet" href="http://iweilian.cn/baijia/themes/default/__RESOURCE__/recouse/css/font-awesome.min.css" />
	<link type="text/css" rel="stylesheet" href="http://iweilian.cn/baijia/themes/default/__RESOURCE__/mobile/style/common.mobile.css">
	<link type="text/css" rel="stylesheet" href="http://iweilian.cn/baijia/themes/default/__RESOURCE__/mobile/style/style.css">
	<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/script/cascade.js"></script>
	<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/mobile/script/jquery.touchwipe.js"></script>
	<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/mobile/script/swipe.js"></script>
	<style type='text/css'>
...
<script src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/recouse/js/zepto.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/recouse/js/cascade.js?x=15"></script>
<script type="text/javascript">
    var from='<?php  echo $from;?>';
    var returnurl = '<?php  echo $returnurl;?>';
cascdeInit('http://iweilian.cn/baijia/themes/default/__RESOURCE__/recouse/js','','','');
...
function editAddress(id) {   
	...
	$.get('<?php  echo mobile_url('address', array('op' => 'detail'))?>', {
		...
		if (s.message) {
			...
			cascdeInit('http://iweilian.cn/baijia/themes/default/__RESOURCE__/recouse/js',s.message.province,s.message.city,s.message.area);
