...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://iweilian.cn/baijia/themes/default/__RESOURCE__/plus/css/style.css?x=1467851791">
    </head>
    <body>
...
<style type="text/css">
    ...
    .header {height: auto; width:100%; padding:0px; background: url(<?php  if(empty($settings['fansindex_bg'])){?>http://iweilian.cn/baijia/themes/default/__RESOURCE__/plus/images/bg11.jpg<?php }else{ ?><?php echo ATTACHMENT_WEBROOT;?><?php  echo $settings['fansindex_bg'];?><?php } ?>) 0 0 no-repeat;background-size: 100% 100%;}
    ...
    <div class="header">
        <div class="user">
            <div class="user-head"><?php  if(empty($avatar)){?><img 
                                                                src="http://iweilian.cn/baijia/themes/default/__RESOURCE__/recouse/images/tx.png"/><?php  }else{ ?><img src="<?php echo $avatar;?>" /><?php  } ?></div>
            <div class="user-info">
